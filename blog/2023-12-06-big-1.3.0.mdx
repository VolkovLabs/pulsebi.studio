...
We are thrilled to announce the release of **Business Intelligence 1.3.0**, a proof-of-concept update from Volkov Labs that sets the stage for significant advancements in our [Business Intelligence platform](/docs/). This release introduces powerful new features and enhancements, including:

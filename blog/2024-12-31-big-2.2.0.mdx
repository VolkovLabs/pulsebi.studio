...
Ready to get started? Download Business Studio from the [links below](#downloads-business-studio-220) or check the [Release Notes](/docs/release/).
...
Check all environment variables directly from the **Environment** tab using the [GET /environment endpoint](/docs/api/). Editing capabilities are planned for a future update.
...
The [GET timeline endpoint](/docs/api/) provides a streamlined history of alert state changes, filtering out duplicate entries for clarity.
...
- **MacOS**:
  - [Apple Disk Image (Silicon)](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-2.2.0-arm64.dmg)
  - [Apple Disk Image (Intel)](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-2.2.0-x64.dmg)
  - [ZIP (Silicon)](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-darwin-arm64-2.2.0.zip)
  - [ZIP (Intel)](https://github.com/VolkovLabs/business-intelligence/releases/download/v2.2.0/Business.Studio-darwin-x64-2.2.0.zip)
- **Linux**:

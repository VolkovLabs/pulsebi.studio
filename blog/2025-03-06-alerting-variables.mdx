...
<Image
  ...
  src="/img/docs/business-alerting/var-1.png"
/>
...
- Navigate to [Business Studio](/docs/studio/) in your BI platform.
...
- Specify [actions](/docs/studio/actions/)—such as sending notifications via Slack or email—when conditions are met.

<Image
  title="Execution and Variable Values sections in alert setup when dashboards use variables."
  src="/img/docs/business-alerting/execution-var-values.png"
/>
...
Ready to elevate your BI game? Start experimenting with dashboard variables in Grafana today and watch your [Business Intelligence](/docs/) strategy evolve into a powerful driver of success.

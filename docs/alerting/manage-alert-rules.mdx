...
<Image
  ...
  src="/img/docs/business-alerting/scheduler.png"
  width="70%"
/>
...
Below is the general description of such a configuration. You can find the detailed [data sources examples](/docs/alerting/datasources/) in dedicated parts of this documentation.
...
<Image
  ...
  src="/img/docs/business-alerting/overrides.png"
/>
...
<Image
  ...
  src="/img/docs/business-engine/multi-frames.png"
/>

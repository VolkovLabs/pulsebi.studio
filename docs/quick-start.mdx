...
2. **Create a Service Account**: Set up a service account in Grafana with **Viewer** or **Editor** permissions to enable the Business Engine to interact with Grafana APIs.
   ...
   <Image
     ...
     src="/img/docs/quick-start/grafana-account.png"
...
<Image
  ...
  src="/img/docs/quick-start/add-engine.png"
...
<Image
  ...
  src="/img/docs/quick-start/connect-grafana.png"
...
As you explore the platform further, consider tailoring Node-RED workflows and Grafana dashboards to align with your specific use cases. For advanced configurations, troubleshooting, or additional features, refer to the detailed documentation and [tutorials](/docs/tutorials/).

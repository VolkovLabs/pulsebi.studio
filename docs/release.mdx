...
Welcome to the release notes for the PulseBI Platform, developed by Volkov Labs to elevate your analytics capabilities.
...
:::info Summary
This major release introduces groundbreaking updates to PulseBI Studio and Engine, focusing on enhanced user experience, advanced security measures, and significant performance improvements.

Key features include revamped alert and reporting capabilities, streamlined UI workflows, and modernized engine architecture, ensuring greater efficiency and scalability for all users.
:::

:::warning Breaking Changes

- **Community Token Update:** The Community Token has been refreshed for this major release. Update your configurations to ensure seamless compatibility with the new token structure.
- **Engine API:** Studio now supports only Engine 4.0.0. Refer to the updated OpenAPI specification for detailed changes and ensure full integration with the latest API standards.
  :::
...
:::info Summary
This release brings significant advancements to platform with enhanced alert and report management, improved performance optimizations, and user-friendly UI updates.

It also introduces new scheduling flexibility, streamlined engine maintenance capabilities, and updated security features, ensuring a more efficient and robust experience for users.
:::
...
<BlogPost id="business-intelligence-3.8.0" />
...
:::info Summary
This release elevates platform with cutting-edge UI enhancements, advanced thresholding and clustering capabilities, improved alert management, streamlined environment configurations, and powerful AI-driven features.

Additionally, it introduces robust database optimizations and enhanced security measures for a more seamless and secure user experience.
:::
...
:::info Summary
This release boosts platform with enhanced alerting, reporting, performance, scheduled dashboard screenshots, improved Firestore security, advanced action templates, GPU-supported rendering, refined alert logic, and subtle UI enhancements for a seamless, accessible experience.
:::
...
:::info Summary
This release brings powerful new features, significant performance optimizations, and critical bug fixes to both Studio and Engine, aimed at improving user experience, system reliability, and operational efficiency.
:::
...
:::info Summary
This release introduces significant enhancements in collaboration, alerting, and performance for both Studio and Engine, focusing on user experience and integration.
:::
...
- **Compatibility**: This version is fully compatible with Engine versions 3.0.0 to 3.3.0.
...
- **Compatibility**: This version is fully compatible with Engine versions 3.0.0 to 3.2.0.
...
- **Compatibility**: This version is fully compatible with Engine versions 3.0.0 to 3.1.0.
...
:::info Summary
This is the General Availability (GA) release of Studio 3.0.0, fully compatible with Engine 3.0.0.
:::
...
The first public preview release of Studio 2.0.0, compatible with Engine 2.0.0.

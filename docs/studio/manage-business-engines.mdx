...
This section assumes you’re familiar with the concept of a Business Engine. If not, review the [platform architecture](/docs/#platform-architecture) and the [Business Engine](/docs/engine/) documentation for context.
...
<Image
  ...
  src="/img/docs/business-engine/add-engine.png"
/>
...
<Image
  ...
  src="/img/docs/business-studio/new-engine.png"
/>
...
<Image
  ...
  src="/img/docs/business-engine/tab-overview.png"
/>
...
The **Alert Rules** page integrates with the [Business Alerting](/docs/alerting/) feature, available across all Business Engines. For details, see the [Alert Rules](/docs/alerting/manage-alert-rules/) section.
...
<Image
  ...
  src="/img/docs/business-studio/alert-rules.png"
/>
...
<Image
  ...
  src="/img/docs/business-studio/alerting.png"
/>

## Actions

The **Actions** page allows configuration of actions—steps triggered by specific events, most commonly alert rule violations, though other scenarios are supported. Learn more in the [Actions](/docs/studio/actions/) section.
...
<Image
  ...
  src="/img/docs/business-studio/tab-env.png"
/>
...
<Image
  ...
  src="/img/docs/business-studio/token.png"
/>
...
<Image
  ...
  src="/img/docs/business-studio/update-engine-license.png"
/>

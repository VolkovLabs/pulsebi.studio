...
### Business Intelligence 2.6.0: Alerting, Action History, and Event Page Updates
...
By leveraging cutting-edge AI models such as Grok 4 from xAI and Anthropic Claude, we’ve transformed [Business Alerting](/docs/alerting/) into a dynamic, context-aware system. This enables intelligent notifications across email, Slack, and Grafana Incident workflows. In this blog post, we’ll explore how AI Observability enhances alerting, enabling teams to respond faster and more effectively to critical issues.
